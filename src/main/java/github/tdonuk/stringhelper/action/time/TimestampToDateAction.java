...
public class TimestampToDateAction extends EditorAction {
        ...
        super(new EditorActionHandler() {
            ...
            protected void doExecute(@NotNull Editor editor, @Nullable Caret caret, DataContext dataContext) {
                ...
                if (selectedText != null && !selectedText.isEmpty()) {
                    try {
                        long epochSeconds = Long.valueOf(selectedText);
                        String result = dateFormatter.format(Date.from(Instant.ofEpochSecond(epochSeconds)));
    ...
    protected TimestampToDateAction(EditorActionHandler defaultHandler) {
